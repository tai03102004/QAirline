...
const flightInfoRoutes = require("./flightInfo.route");
...
module.exports = (app) => {
    ...
    app.use(PATH_ADMIN + "/airports", authMiddleware.requireAuth, airportRoutes);
    app.use(PATH_ADMIN + "/flight_info", authMiddleware.requireAuth, flightInfoRoutes);
